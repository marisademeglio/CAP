...
- [Wave from WebAIM](https://wave.webaim.org/)

- [7-zip - unzips files in any format](https://www.7-zip.org/)

- [NVDA - screen curtain and visual focus tools, great for testing to understand user experience](https://www.nvaccess.org/)
